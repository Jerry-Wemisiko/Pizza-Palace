...
$("#location-form").submit(function (event) {
    ...
    $(".location").hide();
    alert(customerName + ": Your total bill is   Ksh. " + totalCost + ". Your order will be delivered to " + estate + " Estate, House Number   " + houseNumber + " in 20 minutes time.We appreciate your coperation.");
});
